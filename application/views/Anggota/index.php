...
<link rel="stylesheet" href="<?php echo base_url().'assets/dashboard/css/wave/button.min.css'?>">
<link rel="stylesheet" href="<?php echo base_url().'assets/dashboard/css/wave/jquery.dataTables.min.css'?>">
