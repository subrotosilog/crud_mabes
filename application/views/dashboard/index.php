        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <a href="#"><img src="<?php echo base_url().'assets/dashboard/img/logo/logo.png'?>" alt="" /></a>
                    </div>
                </div>
                                ...
                                <div role="menu" class="dropdown-menu message-dd animated zoomIn">
                                    ...
                                    <div class="hd-message-info">
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="<?php echo base_url().'assets/dashboard/img/post/1.jpg'?>" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                                                    <h3>David Belle</h3>
                                        ...
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="<?php echo base_url().'assets/dashboard/img/post/2.jpg'?>" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                                        ...
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="<?php echo base_url().'assets/dashboard/img/post/4.jpg'?>" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a data-toggle="collapse" data-target="#Pagemob" href="#">anggota</a>
                                    <ul id="Pagemob" class="collapse dropdown-header-top">
                                        <li><a href="<?php echo base_url().'anggota/'; ?>">Daftar Anggota</a>
                                        </li>                                        
                                    </ul>
                                </li>
                            </ul>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#Page"><i class="notika-icon notika-support"></i>anggota</a>
                        </li>
                    </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="realtime-wrap notika-shadow mg-t-30">
                        ...
                        <div class="realtime-country-ctn realtime-ltd-mg">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="<?php echo base_url().'assets/dashboard/img/country/1.png'?>"alt="" /></span> <span>United States</span>United States</Span>
                                </div>
                        ...
                        <div class="realtime-country-ctn">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="<?php echo base_url().'assets/dashboard/img/country/2.png'?>" alt="" /></span> <span>Australia</span>
                                </div>
                                <div class="realtime-bw">
                                    <span>Firefox</span>
                                </div>
                        ...
                        <div class="realtime-country-ctn">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    // <span><img src="<?php echo base_url().'assets/dashboard/img/country/3.png'?>" alt="" /></span> <span>Brazil</span>
                                </div>
                                <div class="realtime-bw">
                                    <span>Firefox</span>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-sm-12 col-xs-12 todo-inputbar">
                                            <div class="form-group todo-flex">
                                                ...
                                                <div class="todo-send">
                                                    <button class="btn-primary btn-md btn-block btn notika-add-todo" type="button" id="">Add</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="conversation-list">
                                        <li class="clearfix">
                                            <div class="chat-avatar">
                                                <img src="<?php echo base_url().'assets/dashboard/img/post/1.jpg'?>" alt="male">
                                                <i>10:00</i>
                                            </div>
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="<?php echo base_url().'assets/dashboard/img/post/2.jpg'?>" alt="Female">
                                                <i>10:01</i>
                                            </div>
                                            <div class="conversation-text">
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="<?php echo base_url().'assets/dashboard/img/post/2.jpg'?>" alt="male">
                                                <i>10:02</i>
                                            </div>
                                            <div class="conversation-text">
                                                <div class="ctext-wrap chat-widgets-cn">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="footer-copy-right">
                        <p>Copyright © 2019 
. All rights reserved. Template by <a href="https://www.kompas.com">kompas</a>.</p>
                    </div>
                </div>
            </div>
        </div>
